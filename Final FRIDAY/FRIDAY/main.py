...
from Frontend.GUI import (
    ...
    GetMicrophoneStatus,
    GetAssistantStatus)
from Backend.ImageGeneration import ProcessImageRequestFromDataFile
...
def MainExecution():
    ...
    if ImageExecution:
        ...
        try:
            ...
            ProcessImageRequestFromDataFile()  # ✅ CALL THE FUNCTION DIRECTLY NOW
...
def MainExecution():
    ...
    if G and R or R:
        ...
        for Queries in Decision:
            ...
            elif "system shutdown" in Queries:
               
                TextToSpeech("Shutting down the system  Boss !")
